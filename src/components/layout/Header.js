...
const Header = () => {
  return (
    <header id="header" className=" hidden md:flex bg-white dark:bg-primary rounded-t-lg md:relative md:flex-row md:h-16 md:items-center md:justify-between md:border-b md:border-b-light md:dark:border-b-dark md:px-4 md:text-text-primary">
